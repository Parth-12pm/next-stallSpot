'use client';
// components/profile/steps/AdditionalInfoStep.tsx
      ...
      <div className="grid gap-4">
        <div className="grid gap-2">
          ...
          <div className="flex justify-between text-sm text-muted-foreground">
            ...
            {errors.selfDescription && (
              <p className="text-destructive">{errors.selfDescription}</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-muted/50 p-4 rounded-lg">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>• Be clear and concise about your {isOrganizer ? 'event organization experience' : 'business offerings'}</li>
