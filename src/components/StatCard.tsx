...
export function StatCard({ icon: Icon, number, label }: StatCardProps) {
  return (
    <div className="group bg-card border border-border hover:border-primary/50 hover:bg-accent transition-all duration-300 p-8 rounded-lg shadow-sm hover:shadow-md">
